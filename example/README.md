This folder contains a ready-to-run example of CASPULE's system setup pipeline. 

To generate input, data, colvars, and job submission scripts, download this folder and run the pipeline with 
